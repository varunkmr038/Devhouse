const regex = {
  ...
  // 4. Length  8- 30
  postText: /^[a-zA-Z]([A-za-z0-9]|( (?! ))){3,500}(\s+)?$/, // should start with letter not contain special characters and length between 4 and 100 and spaces at the end are optional and should not contain 2 spaces in between
